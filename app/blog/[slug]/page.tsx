...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
    ...
    const authorName = post.frontmatter.author ?? 'Senior Engineer';
    const authorRole =
